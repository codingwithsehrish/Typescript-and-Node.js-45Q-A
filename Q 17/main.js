...
var shrinkguestlist = ["zainab", "atika", "madiha"];
...
var shrinkguest = Math.floor(shrinkguestlist.length / 2);
...
while (shrinkguestlist.length > 2) {
    ...
    console.log("sorry, ".concat(removeGuest, " i can invit you to dinner"));
}
console.log("invitation for the last two guests");
shrinkguestlist.forEach(function (Guestinvitation) { return console.log("you are still invited for dinner"); });
shrinkguestlist.pop();
shrinkguestlist.pop();
