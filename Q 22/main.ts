...
// CREATING ARRAY:
let errArray: string[] =["A","B","C","D"]

console.log(errArray[7]);//wrong array to call which is not exist.
// which result is undefined.
console.log(errArray[1]); //correct ARRAY to resolve.
// which result is B 